    ...
    <nav class="banner">
        ...
        <div class="dropdown-menu highlight">个人中心
            <ul>
                ...
                <li class="menu_item highlight"><a href="friends.jsp" class="friends">我的好友</a></li>
    ...
    <section class="imgGroup">
        <ul>
            <%
                ...
                String sql = "SELECT UserName,UID FROM traveluser ORDER BY RAND() LIMIT 10";
                ...
                try {
                    ...
                    while (rs.next()) {
                        out.println("<li class='thumbnail'>" +
                                "<a href='friend_favourite.jsp?UID=" + rs.getInt(2) + "&username="+rs.getString(1)+"'>" +
                                "<div class='img-box'>" +
                                "<img src='image/person.png' alt='图片'>" +
                                "</div>" +
                                "<div><h3>" + rs.getString(1) + "</h3>" +
                                "<p></p>" +
                                "</div>" +
                                "</a>" +
                                "</li>");
